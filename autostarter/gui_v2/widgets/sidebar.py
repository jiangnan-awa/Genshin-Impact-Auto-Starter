"""
Sidebar widget skeleton for GUI v2.
...
def build_sidebar(parent: object, spec: Optional[SidebarSpec] = None) -> SidebarController:
    ...
    返回 SidebarController：
    - .frame: sidebar Frame
    - .set_active(key): 设置当前激活项
    """
    ctk = _import_customtkinter()
